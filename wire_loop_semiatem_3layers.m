...
%% z轴阶跃
figure;
loglog(t.*10^3,u0.*abs(hz_01),'r','Linewidth',2);
hold on
loglog(t.*10^3,u0.*abs(hz_10),'b:','Linewidth',2);
grid on;
...
% x轴阶跃
figure;
loglog(t.*10^3,u0.*abs(hx_01),'r','Linewidth',2);
hold on
loglog(t.*10^3,u0.*abs(hx_10),'b:','Linewidth',2);
grid on;
legend('数值解正阶跃响应','数值解负阶跃响应');
...
% y 轴阶跃
figure;
loglog(t.*10^3,u0.*abs(hy_01),'r','Linewidth',2);
hold on
loglog(t.*10^3,u0.*abs(hy_10),'b:','Linewidth',2);
grid on;
legend('数值解正阶跃响应','数值解负阶跃响应');
